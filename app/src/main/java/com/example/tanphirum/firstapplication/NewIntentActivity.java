...
public class NewIntentActivity extends AppCompatActivity implements View.OnClickListener{

    private static final String LOG_TAG = NewIntentActivity.class.getSimpleName();
