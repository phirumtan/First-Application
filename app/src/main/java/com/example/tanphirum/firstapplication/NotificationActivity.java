...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNotifyButton = (Button) findViewById(R.id.btn_notify_me);
        mUpdateButton = (Button) findViewById(R.id.btn_update_me);
        mCancelButton = (Button) findViewById(R.id.btn_cancel_me);
    ...
    private void updateNotification() {
        ...
        Bitmap androidImage = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_profile_image);
